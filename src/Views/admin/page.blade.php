            ...
            <div class="card-header with-border">
                ...
                <div class="card-tools">
                    <div class="btn-group float-right mr-5">
                        <a href="{{ vncore_route_admin('admin_page.index') }}" class="btn  btn-flat btn-default" title="List"><i
                        ...
                        <div class="form-group row  {{ $errors->has('image') ? ' text-red' : '' }}">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div id="preview_image" class="img_holder">
                                    ...
                                    <img src="{{ vncore_file(old('image',($page['image']??''))) }}">
                                    @endif
...
@if (vncore_store_check_multi_domain_installed())
                        ...
                        if (function_exists('vncore_get_list_store_of_page_detail')) {
                                $oldData = vncore_get_list_store_of_page_detail($page['id'] ?? '');
                            } else {
                                $oldData = null;
                            }
...
<script type="text/javascript">
    ...
    {
        filebrowserImageBrowseUrl: '{{ vncore_route_admin('admin.home').'/'.config('lfm.url_prefix') }}?type=page',
        filebrowserImageUploadUrl: '{{ vncore_route_admin('admin.home').'/'.config('lfm.url_prefix') }}/upload?type=page&_token={{csrf_token()}}',
